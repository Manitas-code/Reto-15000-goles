...
'Gol del día':'Goal of the Day','Adivina el gol':'Guess the Goal','Adivina':'Guess','el gol':'the Goal','Adivina el gol · GOALDAY':'Guess the Goal · GOALDAY','Próximamente':'Coming soon',
'Un gol cada día, sin escudos ni marcador. ¿Sabes quién lo marcó?':'One goal every day, no crests, no scoreboard. Do you know who scored it?',
'Más o Menos':'Higher or Lower',
...
// ---- Adivina el gol ----
'Sin escudos, sin colores, sin marcador. Solo la jugada.':'No crests, no colours, no scoreboard. Just the play.',
'Cada pista resta 25 puntos y cada fallo 10. Tienes 3 intentos.':'Each hint costs 25 points and each miss 10. You have 3 tries.',
'¿Quién marcó? Escribe un nombre…':'Who scored? Type a name…','¿Quién marcó?':'Who scored?',
'Competición':'Competition','Contexto':'Context','Nacionalidad':'Nationality','Intentos':'Tries','Me rindo':'I give up',
'Jugados':'Played','Racha 🔥':'Streak 🔥','Siguiente gol en':'Next goal in','No lo he sacado':'Didn\'t get it',
'¡Vaya! Era…':'Oh no! It was…','Prueba otra vez.':'Try again.','Vídeo no disponible':'Video not available',
'▶ Ver el gol':'▶ Watch the goal','▶ Ver jugada':'▶ Watch the play','▶ Ver la jugada':'▶ Watch the play','⟲ Repetir':'⟲ Replay',
'Adivina':'Guess',
// ---- Blackjack v3 (mesa y cartas) ----
'Empiezas con 1.000 fichas. En cada mano apuestas y te reparten dos jugadores; la banca también recibe dos, uno boca abajo.':'You start with 1,000 chips. Each hand you bet and get two players; the house also gets two, one face down.',
...
// ---- Blackjack v2 (sin límite + ranking) ----
'Empiezas con 1.000 fichas. En cada mano apuestas y te llevas un jugador; la banca, dos (uno boca abajo).':'You start with 1,000 chips. Each hand you bet and get one player; the house gets two (one face down).',
'No hay límite de manos. La apuesta mínima es el 10 % de tus fichas. Retírate cuando quieras para guardar tus fichas en el ranking; si te quedas sin fichas, vuelves a empezar.':'There\'s no hand limit. The minimum bet is 10% of your chips. Cash out whenever you want to put your chips on the ranking; if you run out of chips, you start over.',
...
'Te has quedado sin fichas: vuelves al principio':'Out of chips: back to the start',
'Guardando en el ranking mundial…':'Saving to the world ranking…','No se ha podido guardar en el ranking.':'Couldn\'t save to the ranking.',
'Elige tu nombre para salir en el ranking mundial:':'Choose your name to appear in the world ranking:',
'Mínimo 2 caracteres.':'At least 2 characters.','Ese nombre ya lo tiene otro jugador. Elige otro.':'That name is already taken. Choose another.',
...
'Empiezas con 1.000 fichas y juegas 10 manos. En cada mano apuestas y te llevas un jugador; la banca, dos (uno boca abajo).':'You start with 1,000 chips and play 10 hands. Each hand you bet and get one player; the house gets two (one face down).',
...
'Clavar el objetivo paga el doble. Si te quedas sin fichas, se acabó.':'Hitting the target exactly pays double. Run out of chips and it\'s game over.',
'Récord de fichas':'Chip record','Manos':'Hands','Mano':'Hand','Fichas':'Chips','Banca':'House','OBJETIVO':'TARGET',
'Apuesta':'Bet','Todo':'All in','Repartir':'Deal','Repartiendo…':'Dealing…','Siguiente jugador':'Next player',
...
'fichas al final · ¡nuevo récord!':'chips at the end · new record!','te has quedado sin fichas · ¡nuevo récord!':'out of chips · new record!',
'Blackjack de goles':'Blackjack','Blackjack':'Blackjack',
'Juega contra la banca con fichas: pide jugadores sin ver sus goles y no te pases.':'Play against the house with chips: draw players without seeing their goals and don\'t go over.',
// ---- Más o Menos ----
'Más o Menos · GOALDAY':'Higher or Lower · GOALDAY',
'Más o':'Higher or','menos':'lower',
...
'Guardar':'Save','Ahora no':'Not now','Tu nombre':'Your name','Mantén pulsada la imagen para guardarla, o usa el botón.':'Press and hold the image to save it, or use the button.','Compartir':'Share','Cerrar':'Close','Cancelar':'Cancel','Continuar':'Continue','Aceptar':'OK',
// ---- equipo ----
...
'Ese nombre ya lo tiene otro jugador. Elige otro.':'That name is already taken. Choose another one.','Mínimo 2 caracteres.':'Minimum 2 characters.','No se ha podido guardar. Revisa la conexión.':'Couldn\'t save. Check your connection.','No se pudo subir la puntuación. Revisa la conexión.':'Couldn\'t upload the score. Check your connection.','Sin conexión':'No connection','Revisa la conexión y vuelve a intentarlo.':'Check your connection and try again.',
'Tu rango sube con tu mejor puntuación; una vez alcanzado no se pierde.':'Your rank rises with your best score; once reached, it\'s never lost.','Tus medallas':'Your medals','Logros desbloqueados:':'Achievements unlocked:','Logro desbloqueado':'Achievement unlocked','Logro oculto':'Hidden achievement','Descúbrelo jugando':'Find out by playing','Siguiente rango:':'Next rank:','Siguiente categoría:':'Next tier:','Rango máximo alcanzado':'Maximum rank reached','Has llegado al rango máximo':'You\'ve reached the maximum rank','TU RANGO':'YOUR RANK','TU RANGO ACTUAL':'YOUR CURRENT RANK','HAS SUBIDO DE RANGO':'RANK UP','¡HAS SUBIDO DE RANGO!':'RANK UP!','XP para el siguiente nivel':'XP to next level','Todo desbloqueado · eres el 0,0001%':'Everything unlocked · you\'re the 0.0001%',
// rangos
...
'Cada mes es una temporada: el día 1 se guarda tu clasificación como medalla y los puntos se reinician a mitad de camino de 1.000. Todos empiezan con 1.000 puntos en la Saudi Pro League. Ganar un duelo suma y perderlo resta; en los primeros duelos subes y bajas más rápido.':'Every month is a season: on the 1st your ranking is saved as a medal and points reset halfway towards 1,000. Everyone starts with 1,000 points in the Saudi Pro League. Winning a duel adds points and losing subtracts; in your first duels you rise and fall faster.',
// imagen compartida
...
'Reto de los 15.000 goles ⚽':'15,000 Goals Challenge ⚽','¿Lo superas tú?':'Can you beat it?'
};
var RULES=[
 [/^Competición · −(\d+)$/,'Competition · −$1'],[/^Contexto · −(\d+)$/,'Context · −$1'],[/^Nacionalidad · −(\d+)$/,'Nationality · −$1'],
 [/^Pista (\d+)$/,'Hint $1'],
 [/^No es (.+)\.$/,'It\'s not $1.'],
 [/^No es (.+)\. Prueba otra vez\.$/,'It\'s not $1. Try again.'],
 [/^¡Correcto! (\d+) puntos$/,'Correct! $1 points'],
 [/^(\d+) puntos$/,'$1 points'],
 ...
 [/^([+−])([\d.]+) fichas$/,'$1$2 chips'],
 [/^💰 Retirarme con ([\d.]+) fichas$/,'💰 Cash out with $1 chips'],
 [/^Te retiras con ([\d.]+) fichas tras (\d+) manos · ¡nuevo récord!$/,'You cash out with $1 chips after $2 hands · new record!'],
 [/^Te retiras con ([\d.]+) fichas tras (\d+) manos$/,'You cash out with $1 chips after $2 hands'],
 [/^🌍 Guardado en el ranking mundial como (.+)$/,'🌍 Saved to the world ranking as $1'],
 [/^Goles en toda su carrera\. Objetivo ([\d.]+)\.$/,'Career goals. Target $1.'],
 [/^Goles con su selección\. Objetivo ([\d.]+)\.$/,'National team goals. Target $1.'],
 [/^Récord: ([\d.]+) fichas$/,'Record: $1 chips'],
 [/^La banca se planta al llegar a ([\d.]+)$/,'The house stands at $1'],
 [/^Tú ([\d.]+) · Banca ([\d.]+) · ([+−])([\d.]+) fichas$/,'You $1 · House $2 · $3$4 chips'],
 [/^([\d.]+) goles · ([+−])([\d.]+) fichas$/,'$1 goals · $2$3 chips'],
 [/^fichas al final · récord: ([\d.]+)$/,'chips at the end · record: $1'],
 [/^te has quedado sin fichas · récord: ([\d.]+)$/,'out of chips · record: $1'],
 [/^Récord: (\d+)$/,'Record: $1'],
 [/^aciertos? seguidos? · récord: (\d+)$/,'correct in a row · record: $1'],
 [/^(.+) tiene ([\d.]+) y (.+?) ([\d.]+)\.$/,'$1 has $2 and $3 has $4.'],
 [/^Jugador (\d+) de 17$/,'Player $1 of 17'],
 [/^Esta partida (.+?) vale ×5\. ¿Dónde colocas a (.+?)\?$/,'This game $1 is worth ×5. Where do you place $2?'],
 [/^¿Dónde colocas a (.+?)\?$/,'Where do you place $1?'],
 [/^Liga ×5 de hoy: (.+)$/,'Today\'s ×5 league: $1'],
 [/^Reto diario del (.+)$/,'Daily challenge of $1'],
 [/^Reto diario (.+)$/,'Daily challenge $1'],
 [/^Hoy ya lo has jugado: (.+)$/,'You\'ve already played today: $1'],
 [/^Ya has jugado el reto diario de hoy: (.+)$/,'You\'ve already played today\'s daily challenge: $1'],
 [/^Va por el jugador (\d+)/,'They\'re on player $1'],
 [/^Juegas como: (.+)$/,'Playing as: $1'],
 [/^Nombre registrado: (.+)$/,'Name registered: $1'],[/^Nombre cambiado: (.+)$/,'Name changed: $1'],
 [/^La mejor colocación posible de estos 17 daba (.+)$/,'The best possible placement of these 17 gave $1'],
 [/^Me faltaron (.+?) puntos para el objetivo/,'I was $1 points short of the target'],
 [/^Te faltan (.+?) puntos para (.+)$/,'You need $1 points to $2'],
 [/^No llegas: te faltan (.+?) puntos/,'Not there yet: you need $1 points'],
 [/^(.+?) puntos, suficientes para el reto\./,'$1 points, enough for the challenge.'],
 [/^Siguiente rango: (.+)$/,'Next rank: $1'],
 [/^⬆️ ¡Ascenso a (.+?)!$/,'⬆️ Promoted to $1!'],[/^⬇️ Desciendes a (.+)$/,'⬇️ Relegated to $1'],
 [/^⚔️ Duelo contra (.+)$/,'⚔️ Duel against $1'],[/^🤝 Duelo amistoso contra (.+)$/,'🤝 Friendly duel against $1'],[/^Preparando el duelo con (.+)$/,'Preparing the duel with $1'],
 [/^🔁 (.+?) quiere la revancha$/,'🔁 $1 wants a rematch'],[/^(.+?) jugó tu reto$/,'$1 played your challenge'],[/^(.+?) ha jugado tu reto: (.+)$/,'$1 played your challenge: $2'],[/^(.+?) te reta$/,'$1 challenges you'],[/^(.+?) ha entrado!$/,'$1 has joined!'],
 [/^🏆 Ganas: (.+)$/,'🏆 You win: $1'],[/^🏅 Logro: (.+)$/,'🏅 Achievement: $1'],[/^❓ Logro oculto: (.+)$/,'❓ Hidden achievement: $1'],
 [/^TOP 1 TEMPORADA (\d+) · (.+?) · (.+?) puntos$/,'TOP 1 SEASON $1 · $2 · $3 points'],
 [/^🏆 (.+?) · quedan (\d+) días$/,'🏆 $1 · $2 days left'],
 [/^Temporada (\d+) · (.+)$/,'Season $1 · $2'],
 [/^Empieza la (.+?)\. Los puntos se han reiniciado a mitad de camino(.*)$/,'$1 starts. Points have been reset halfway$2'],
 [/^: ahora tienes (.+?) puntos(.*)$/,': you now have $1 points$2'],
 [/^⬆️ subes (\d+) puestos?$/,'⬆️ up $1 place(s)'],[/^⬇️ bajas (\d+) puestos?$/,'⬇️ down $1 place(s)'],
 [/^(.+?) puntos para entrar en el top 50$/,'$1 points to enter the top 50'],[/^(.+?) puntos para pasar al? (.+)$/,'$1 points to reach $2'],[/^(.+?) puntos para el Mundial$/,'$1 points for the World Cup'],
 [/^🌍 Vas (\d+)º del mundo(.*)$/,'🌍 You\'re $1th in the world$2'],
 [/^🌍 Tu récord \((.+?)\) (.+)$/,'🌍 Your record ($1) $2'],
 ...
 [/^⚔️ He hecho (.+?) puntos en el Reto de los 15\.000 goles\. Te tocan mis mismos 17 jugadores\. ¿Me ganas\?$/,'⚔️ I scored $1 points in the 15,000 Goals Challenge. You get my same 17 players. Can you beat me?'],
 ...
 [/^Reto de los 15\.000 goles ⚽ (.+?) puntos(.*)$/,'15,000 Goals Challenge ⚽ $1 points$2']
];
var FRAG=[
 ['Adivina el gol','Guess the Goal'],['No lo he sacado','Didn\'t get it'],['🔥 racha','🔥 streak'],[' puntos',' points'],
 ['💰 Me he retirado con','💰 I cashed out with'],['💸 Me he quedado sin fichas en la mano','💸 I ran out of chips on hand'],
 ['💸 Sin fichas en la mano','💸 Out of chips on hand'],['fichas tras','chips after'],[' manos',' hands'],
 ['Más o Menos','Higher or Lower'],['Goles en toda su carrera','Career goals'],['Goles con su selección','National team goals'],['Racha de','Streak of'],
 ['. ¿Dónde colocas a','. Where do you place'],['¿Dónde colocas a','Where do you place'],['Descartes:','Discards:'],['Liga ×5 de hoy:','Today\'s ×5 league:'],['La mejor colocación posible de estos 17 daba','The best possible placement of these 17 gave'],['Me faltaron','I was short by'],['. Cada jugador aparece una vez, con su récord.','. Each player appears once, with their record.'],['Ya has jugado el reto diario de hoy:','You\'ve already played today\'s daily challenge:'],['. Vuelve mañana.','. Come back tomorrow.'],['puntos. Vuelve mañana.','points. Come back tomorrow.'],
 ['🌍 En el reto de hoy aún no estás en el top 50 · te faltan','🌍 In today\'s challenge you\'re not in the top 50 yet · you need'],
 ['🌍 En el reto de hoy vas','🌍 In today\'s challenge you\'re'],['🌍 Aún no estás en el top 50 · a tu récord (','🌍 Not in the top 50 yet · your record ('],
 ['puntos para entrar en el top 50','points to enter the top 50'],['puntos para pasar al','points to reach'],['puntos para pasar a','points to reach'],['puntos para el Mundial','points for the World Cup'],['puntos en una partida','points in a game'],['puntos para el objetivo','points to the target'],['puntos para entrar','points to enter'],
 ['de los jugadores llega aquí','of players get here'],['· la consiguen','· achieved by'],['de los jugadores','of players'],['del mundo en duelos','in the world in duels'],['y juegas el Mundial','and you play the World Cup'],['· rango máximo','· max rank'],['· ¡con esta partida!','· with this game!'],['· ¡vas primero!','· you\'re first!'],['· le has ganado','· you beat them'],['· te ha ganado','· they beat you'],['· le ganaste','· you beat them'],['le ganaste','you beat them'],['· te ganó','· they beat you'],['te ganó','they beat you'],['· empate','· draw'],['· a medias','· unfinished'],['a medias','unfinished'],['no terminó','didn\'t finish'],['ganó a','beat'],['perdió','lost'],['empate','draw'],
 ['Mejor marca','Best score'],['con récord','with record'],['· máximo','· max'],['· quedan','· left:'],['· desde','· since'],['· te faltan','· you need'],['· te quedan','· you have'],['Te faltan','You need'],['te faltan','you need'],['le faltan','they need'],['º del mundo','th in the world'],['del mundo','in the world'],['Estás en el','You\'re in the'],['contra tus','against your'],['tu amigo','your friend'],['· TOP','· TOP'],['Top 50','Top 50'],['top 50','top 50'],
 ['Reto de los 15.000 goles','15,000 Goals Challenge'],['Reto de los','The'],['Tu reto de','Your challenge of'],['Tu reto','Your challenge'],['Reto diario','Daily challenge'],['reto diario','daily challenge'],['reto de hoy','today\'s challenge'],['Esperando a','Waiting for'],['Esta partida','This game'],['vale ×5.','is worth ×5.'],['Va por el jugador','They\'re on player'],['Jugador','Player'],['jugadores','players'],['jugador','player'],['puntos','points'],['partidas','games'],['partida','game'],['terminaste en','you finished'],['¡Dentro!','In!'],['Aceptar','OK'],['Acepta','Accept'],['🔥 Bonus','🔥 Bonus'],['Vuelve mañana','Come back tomorrow'],['Hoy','Today'],['hoy','today']
];
var lang='es';
...
function tr(s){
  ...
  var out=D[core];
  if(out==null){
    for(var i=0;i<RULES.length;i++){if(RULES[i][0].test(core)){out=core.replace(RULES[i][0],RULES[i][1]);break;}}
  }
  if(out==null){
    out=core;
    for(var j=0;j<FRAG.length;j++){if(out.indexOf(FRAG[j][0])>=0)out=out.split(FRAG[j][0]).join(FRAG[j][1]);}
  }
  return m[1]+out+m[3];
}
...
function start(){
  ...
  if(lang==='en'){walk(document.body);document.title=D[T0]||tr(T0);}
