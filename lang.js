...
'Todo':'All in','Repartir':'Deal','Repartiendo…':'Dealing…',
...
var RULES=[
 ...
 [/^No se ha podido subir tu récord al ranking\. Motivo: (.+)$/,'Couldn\'t upload your record to the ranking. Reason: $1'],
 [/^Tu récord \(([\d.]+) fichas\) aún no está en el ranking porque en este navegador no tienes nombre\. Retírate una vez y elige tu nombre\.$/,'Your record ($1 chips) isn\'t on the ranking yet because you have no name in this browser. Cash out once and choose your name.'],
 ...
 [/^Te retiras con ([\d.]+) fichas tras (\d+) manos( · ¡nuevo récord!)?$/,function(m){return 'You cash out with '+m[1]+' chips after '+pl(m[2],'hand','hands')+(m[3]?' · new record!':'');}],
 [/^💰 Me he retirado con ([\d.]+) fichas tras (\d+) manos$/,function(m){return '💰 I cashed out with '+m[1]+' chips after '+pl(m[2],'hand','hands');}],
